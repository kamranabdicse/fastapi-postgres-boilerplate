...
class CRUDUser(CRUDBase[User, UserCreate, UserUpdate]):
    def get_by_email(self, db: Session | AsyncSession, *, email: str) -> User | None | Awaitable[User | None]:
    ...
    def update(
        self, db: Session | AsyncSession, *, db_obj: User, obj_in: Union[UserUpdate, Dict[str, Any]]
    ) -> User | Awaitable[User]:
    ...
    def authenticate(self, db: Session | AsyncSession, *, email: str, password: str) -> User | None | Awaitable[User | None]:
